        ...
        <View style={{ flex: 9 }}>
          ...
          >
            ...
            >
              ...
              {/* amount */}
              <Text style={styles.header4}>Quantity</Text>
              <Text style={styles.header5}>Price</Text>
              <Text style={styles.header6}>Amount</Text>
            </View>
            {/* Rows Data */}
            {Data.map((data) => {
              return (
                ...
                >
                  {/* Date */}
                  <Text style={styles.cell1}>{data.date}</Text>
                  {/* Bill No */}
                  <Text style={styles.cell2}>{data.bill}</Text>
                  {/* Name */}
                  <Text style={styles.cell3}>{data.name}</Text>
                  {/* Qty */}
                  <Text style={styles.cell4}>{data.qty}</Text>
                  {/* Price */}
                  <Text style={styles.cell5}>{data.price}/-</Text>
                  {/* Amount */}
                  <Text style={styles.cell6}>{data.amount}/-</Text>
                </View>
              );
            })}
            {/* ************************************* */}
